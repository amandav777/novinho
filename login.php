                        ...
                        <div class="row">
                            ...
                            <form action="validacao.php" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" id="password" name="senha" class="form-control" placeholder="Insira sua senha" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="./index.html">
                                        <button class="botaoLogin " type="button">Entrar</button>
                                    </div></a>
                                    <div class="mt-4 d-flex justify-content-center">Não possui login? <a href="register.html">   Registre-se <span></span></a></div>
